...
ActiveRecord::Schema.define(version: 20160226171445) do
  ...
  add_index "follows", ["twitter_id"], name: "fk_rails_473d7a9ee6", using: :btree
  ...
  add_index "twits", ["twitter_id"], name: "index_twits_on_twitter_id", using: :btree
  ...
  add_foreign_key "follows", "twitters"
  add_foreign_key "follows", "twitters", column: "followed_id"
  add_foreign_key "twits", "twitters"
end
